...
- **NFR-04 Test coverage** — Coverage target ~**70%+** (docs reference 72%+). Coverage is measured via test suite and reported in artifacts (`target/surefire-reports/`).
...
*Generated automatically by the repository maintainer tooling.*
