# Advanced Banking System - Design Patterns Showcase

## Project Overview

This project demonstrates **six classical design patterns** in a practical banking system context. The design prioritizes **pattern clarity** and **architectural elegance** over feature completeness.

**Core Message**: "A modular banking core demonstrating six classical design patterns, optimized for extensibility and maintainability."
